 ...
 */
ModelCtrl.prototype.buildIntraProceduralModelsForEachPageModels = function () {
	"use strict";
	internal(this)._collectionOfPageModels.forEach(function (pageModels) {
 ...
 */
ModelCtrl.prototype.analyzeIntraProceduralModelsOfEachPageModels = function () {
	"use strict";
	internal(this)._collectionOfPageModels.forEach(function (pageModels) {
