...
/// FIXME: fix to support inter-procedural
function findReachDefinitions(cfgWrapper, entryRDs, startNode) {
    ...
    return worklist(newCFG, function (input) {
        ...
        return (this === startNode)? Set.union(Set.minus(Set.union(input, entryRDs), killSet), generate) : Set.union(Set.minus(input, killSet), generate);
