 ...
 * @returns {Array} Intra-procedural models of pages
 */
ModelBuilder.prototype.buildIntraProceduralModels = function () {
    "use strict";
    var intraProceduralModelsOfPages = [];
	scopeCtrl.pageScopeTrees.forEach(function (scopeTree) {
		...
		intraProceduralModelsOfPages.push(models);
	});
 ...
 * @param {ScopeCtrl} scopeTree
 * @returns {Array}
 * @function
 */
ModelBuilder.prototype.buildInterProceduralModels = function (scopeTree) {
    "use strict";
    var interProceduralAnalysisItems = [];
    if (ScopeTree.isScopeCtrl(scopeTree)) {
