 ...
 */
var analyzedcfgFactory = require('./modelfactory'),
 ...
 * @function
 */
ModelBuilder.prototype.buildIntraProceduralAnalysisItems = function (scopeTree) {
    "use strict";
    var analyzedCFGs = [];
...
ModelBuilder.prototype.buildIntraPageAnalysisItem = function (analysisItemCtrl, scopeTree) {
    ...
    var validHandlers = [],
        ...
        newAnalyzedItem = [];
    if (AnalysisItemCtrl.isAnalysisItemCtrl(analysisItemCtrl) && ScopeTree.isScopeCtrl(scopeTree)) {
