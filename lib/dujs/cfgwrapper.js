...
function CFGWrapper(cfg, scope, parent) {
    ...
    internal(this).def = new Def(
        (!!internal(this).parent)? internal(this).parent.getCFG()[0] : internal(this).cfg[0],
        Def.FUNCTION_TYPE,
        internal(this).range,
        (!!internal(this).parent)? internal(this).parent.getScope() : Scope.GLOBAL_SCOPE
    );
 ...
 * @function
 */
CFGWrapper.prototype.updateRDs = function (node, addReachIns) {
    'use strict';
 ...
 * @function
 */
CFGWrapper.prototype.addReachInEntry = function (reachIns) {
    "use strict";
    ...
    if (!!reachIns) {
        ...
        reachIns = (!!internal(this).reachIns.get(internal(this).cfg[0]))? Set.union(internal(this).reachIns.get(internal(this).cfg[0]), reachIns) : reachIns;
        if (valid) {
            internal(this).reachIns.set(internal(this).cfg[0], reachIns);
        }
    }
};
