...
/**
 * Create and return CFG of global scope
 * @returns {Array}
 * @function
 */
CFGExt.prototype.getGlobalCFG = function () {
    "use strict";
    var globalNode = factoryFlowNode.createGlobalNode();
    globalNode.cfgId = internal(this)._lastCFGId++;
    globalNode.line = 0;
    globalNode.col = 0;
    return [globalNode, globalNode, [globalNode]];
};
