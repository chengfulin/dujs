...
function main(source, callback) {
    ...
    callback(returnError, [].concat(intraProceduralAnalysisItems).concat(interProceduralAnalysisItems).concat(intraPageAnalysisItems));
}
