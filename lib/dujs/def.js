 ...
 */
function Def(from, type, scope) {
    'use strict';
    Def.validate(from, type, scope);
 ...
 * @function
 */
Def.validate = function (from, type, scope, msg) {
    'use strict';
...
Def.prototype.toString = function () {
    'use strict';
    return internal(this)._type + '@n' + internal(this)._fromCFGNode.cfgId + '@' + internal(this)._scope;
};
