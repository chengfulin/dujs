...
ScopeTree.prototype.getScopeByRange = function (range) {
    ...
    if (Range.isRange(range)) {
        return internal(this).mapFromRangeToScope.get(range.toString());
    } else if (typeof range === 'string') {
        return internal(this).mapFromRangeToScope.get(range);
    }
};
...
ScopeTree.prototype.getScopeByDef = function (definition) {
    'use strict';
    return internal(this).mapFromDefToScope.get(definition);
};
...
ScopeTree.prototype.getScopeByScopeName = function (scopeName) {
    ...
    if (Scope.isScope(scopeName)) {
        ...
        return internal(this).mapFromScopeNameToScope.get(scopeName.toString());
    } else if (typeof scopeName === 'string') {
        return internal(this).mapFromScopeNameToScope.get(scopeName);
    }
};
