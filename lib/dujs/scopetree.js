...
var CFGExt = require('./cfgext'),
    CFGWrapper = require('./scopewrapper'),
    Scope = require('./scope'),
    Var = require('./var'),
    Def = require('./def'),
    Range = require('./range'),
    ...
    cfgwrapperFactory = require('./index').factoryCFGWrapper,
    nodeFactory = require('../esgraph/flownodefactory'),
...
function FunctionScopeTree(ast) {
    ...
    internal(this)._globalScope = getGlobalScope();
    internal(this).root = internal(this)._globalScope;
...
/**
 * Add a function scope (ScopeWrapper type) into the tree
 * @param tree
 * @param fscope
 * @private
 */
...
function getGlobalScope() {
    "use strict";
    var globalNode = nodeFactory.create(FlowNode.GLOBAL_NODE_TYPE, null, null);
    return cfgwrapperFactory.create([globalNode, globalNode, [globalNode]], Scope.GLOBAL_SCOPE, null);
}
...
FunctionScopeTree.prototype.addGlobalVarDef = function (name, type) {
    "use strict";
