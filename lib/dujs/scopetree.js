 ...
 * @function
 */
/// FIXME: can get the definition generated inside callee scope from outside but missed the use at call expression of callee
            ...
            walkes(cfgNode.astNode, {
                ...
                CallExpression: function (node) {
                    ...
                    calleeScopeDefs.forEach(function (def) {
                        ...
                        cfgNode.next.forEach(function (node) {
                            currentScope.updateRDs(
                                node,
                                Set.union(
                                    currentScope.getReachIns().get(node),
                                    Set.union(
                                        currentScope.getReachOuts().get(cfgNode),
...
FunctionScopeTree.prototype.findInterProceduralCFG = function () {
    'use strict';
    /// handle inter-procedural
    recursivelyUpdateCFG(this, internal(this).root);
};
            ...
            walkes(cfgNode.astNode, {
                ...
                CallExpression: function (node) {
                    ...
                    calleeScopeDefs.forEach(function (def) {
                        ...
                        currentScope.getCFG()[2].concat(calleeScope.getCFG()[2]);
                        recursivelyUpdateCFG(tree, calleeScope);
                    });
                }
            });
        });
