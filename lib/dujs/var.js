...
Object.defineProperty(Var, 'DEFAULT_RETURN_VAR_NAME', {
...
Var.isValidName = function (name) {
    ...
    return name === Var.RETURN_VAR_NAME || name === Var.DEFAULT_RETURN_VAR_NAME || (typeof name === 'string' && identifierFormat.test(name));
};
