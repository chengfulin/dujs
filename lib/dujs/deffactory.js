...
DefFactory.prototype.createParamDef = function (functionScope, type, range) {
    'use strict';
    return new Def(functionScope.getCFG()[0], type, range, functionScope.getScope());
};
...
DefFactory.prototype.createLiteralParamDef = function (functionScope, range) {
    'use strict';
    return new Def(functionScope.getCFG()[0], Def.LITERAL_TYPE, range, functionScope.getScope());
};
...
DefFactory.prototype.createObjectParamDef = function (functionScope, range) {
    'use strict';
    return new Def(functionScope.getCFG()[0], Def.OBJECT_TYPE, range, functionScope.getScope());
};
...
DefFactory.prototype.createFunctionParamDef = function (functionScope, range) {
    'use strict';
    return new Def(functionScope.getCFG()[0], Def.FUNCTION_TYPE, range, functionScope.getScope());
};
...
DefFactory.prototype.createHTMLDOMParamDef = function (functionScope, range) {
    'use strict';
    return new Def(functionScope.getCFG()[0], Def.HTML_DOM_TYPE, range, functionScope.getScope());
};
...
DefFactory.prototype.createUndefinedParamDef = function (functionScope, range) {
    'use strict';
    return new Def(functionScope.getCFG()[0], Def.UNDEFINED_TYPE, range, functionScope.getScope());
};
...
DefFactory.prototype.createLocalStorageParamDef = function (functionScope, range) {
    'use strict';
    return new Def(functionScope.getCFG()[0], Def.LOCAL_STORAGE_TYPE, range, functionScope.getScope());
};
