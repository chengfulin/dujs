...
function GlobalScopeCtrl() {
    ...
    internal(this)._scope = scopewrapperFactory.createGlobalScopeWrapper([
        internal(this)._localStorageNode,
        internal(this)._localStorageNode,
        [internal(this)._localStorageNode]
    ]);

    initialization(internal(this)._localStorageNode, internal(this)._scope);
 ...
 * @param {ScopeWrapper} scope global scope
 * @private
 * @function
 */
...
Object.defineProperty(GlobalScopeCtrl.prototype, 'graph', {
    get: function () {
        "use strict";
        return [].concat(internal(this)._scope.cfg);
    }
});
