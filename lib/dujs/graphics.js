...
Graphics.prototype.analysisItemToCFG = function (analysisItem, option) {
    ...
    var dotOption = option || {'toDot': false, 'toDotWithLabelId': false, 'toDotWithLabelLine': false, 'toDotWithLabelLoc': true};
    if (dotOption.toDot) {
        converter = CFGExt.toDot;
    } else if (dotOption.toDotWithLabelId) {
        converter = CFGExt.toDotWithLabelId;
    } else if (dotOption.toDotWithLabelLine) {
        converter = CFGExt.toDotWithLabelLine;
    } else if (dotOption.toDotWithLabelLoc) {
        converter = CFGExt.toDotWithLabelLoc;
    } else {
        converter = CFGExt.toDotWithLabelLine;
    }
