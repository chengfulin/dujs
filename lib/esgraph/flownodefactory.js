...
FlowNodeFactory.prototype.createNormalNode = function (astNode, parent) {
    "use strict";
    return new FlowNode(FlowNode.NORMAL_NODE_TYPE, astNode, parent);
};
...
FlowNodeFactory.prototype.createEntryNode = function () {
    "use strict";
    return new FlowNode(FlowNode.ENTRY_NODE_TYPE, null, null);
};
...
FlowNodeFactory.prototype.createExitNode = function () {
    "use strict";
    return new FlowNode(FlowNode.EXIT_NODE_TYPE, null, null);
};
...
FlowNodeFactory.prototype.createCallNode = function () {
    "use strict";
    return new FlowNode(FlowNode.CALL_NODE_TYPE, null, null);
};
...
FlowNodeFactory.prototype.createCallReturnNode = function () {
    "use strict";
    return new FlowNode(FlowNode.CALL_RETURN_NODE_TYPE, null, null);
};
...
FlowNodeFactory.prototype.createLoopNode = function () {
    "use strict";
    return new FlowNode(FlowNode.LOOP_NODE_TYPE, null, null);
};
...
FlowNodeFactory.prototype.createLoopReturnNode = function () {
    "use strict";
    return new FlowNode(FlowNode.LOOP_RETURN_NODE_TYPE, null, null);
};

/**
 * Factory method for global node
 * @returns {FlowNode}
 * @function
 */
FlowNodeFactory.prototype.createGlobalNode = function () {
    "use strict";
    return new FlowNode(FlowNode.GLOBAL_NODE_TYPE, null, null);
};
