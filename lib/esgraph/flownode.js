...
/**
 * Type of the Halt Node
 * @type {string}
 */
Object.defineProperty(FlowNode, 'HALT_NODE_TYPE', {
    value: 'halt',
    writable: false,
    enumerable: false,
    configurable: false
 ...
 * @type {string}
 */
Object.defineProperty(FlowNode, 'LOCAL_STORAGE_NODE_TYPE', {
    value: 'localStorage',
    writable: false,
    enumerable: false,
    configurable: false
 ...
 * @type {string}
 */
Object.defineProperty(FlowNode, 'SAVE_STORAGE_CONNECTION_TYPE', {
    value: 'saveStorage',
    writable: false,
    enumerable: false,
    configurable: false
 ...
 * @type {string}
 */
Object.defineProperty(FlowNode, 'LOAD_STROAGE_CONNECTION_TYPE', {
    value: 'loadStorage',
    writable: false,
    enumerable: false,
    configurable: false
...
Object.defineProperty(FlowNode, 'MULTI_CONNECTION_TYPE', {
    value: [
        FlowNode.RETURN_CONNECTION_TYPE,
        FlowNode.ON_EVENT_CONNECTION_TYPE,
        FlowNode.LOAD_STROAGE_CONNECTION_TYPE
...
Object.defineProperty(FlowNode, 'DATAFLOW_CONNECTION', {
    value: [
        FlowNode.LOAD_STROAGE_CONNECTION_TYPE,
        FlowNode.SAVE_STORAGE_CONNECTION_TYPE
    ],
...
Object.defineProperty(FlowNode.prototype, 'reachIns', {
    get: function () {
        "use strict";
...
Object.defineProperty(FlowNode.prototype, 'reachOuts', {
    get: function () {
        "use strict";
...
Object.defineProperty(FlowNode.prototype, 'scope', {
    get: function () {
        "use strict";
    ...
    set: function (scopeWrapper) {
        "use strict";
        internal(this)._name = scopeWrapper;
    }
});
...
FlowNode.prototype.disconnect = function (nextNode) {
    ...
    if (FlowNode.isFlowNode(nextNode)) {
        ...
        removeNext(thisNode, nex.tNode);
        removePrev(nextNode, thisNode);
    }
    return this;
};

FlowNode.prototype.setGENSetEmpty = function () {
    "use strict";
    internal(this)._generate = new Set();
};

FlowNode.prototype.setKILLSetEmpty = function () {
    "use strict";
...
FlowNode.prototype.toString = function () {
    'use strict';
    return (!internal(this)._label)? ('n' + internal(this)._cfgId) : (internal(this)._label);
};

FlowNode.prototype.toJSON = function () {
	'use strict';
	var prevJSON = [], nextJSON = [];
	internal(this)._prev.forEach(function (node) {
		prevJSON.push(node.toJSON());
	});
	internal(this)._next.forEach(function (node) {
		nextJSON.push(node.toJSON());
	});

	return {
		"cfgId": internal(this)._cfgId,
		"type": internal(this)._type,
		"label": internal(this)._label || null,
		"prev": prevJSON,
		"next": nextJSON
	};
};
