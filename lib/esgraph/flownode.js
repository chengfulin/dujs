...
Object.defineProperty(FlowNode.prototype, 'kill', {
    get: function () {
        "use strict";
        return new Set(internal(this)._kill);
    }
});
...
Object.defineProperty(FlowNode.prototype, 'generate', {
    get: function () {
        "use strict";
        return new Set(internal(this)._generate);
    }
});
...
Object.defineProperty(FlowNode.prototype, 'cuse', {
    get: function () {
        "use strict";
        return new Set(internal(this)._cuse);
    }
});
...
Object.defineProperty(FlowNode.prototype, 'puse', {
    get: function () {
        "use strict";
        return new Set(internal(this)._puse);
    }
});
...
/**
 * Add a node into the collection of previous nodes of the current node
 * @param {FlowNode} prevNode
 * @returns {boolean}
 * @function
 */
FlowNode.prototype.addPrev = function (prevNode) {
    "use strict";
    if (FlowNode.isFlowNode(prevNode) && !this.hasPrev(prevNode)) {
        internal(this)._prev.push(prevNode);
    }
};

/**
 * Add a node into the collection of next nodes of the current node
 * @param {FlowNode} nextNode
 * @returns {boolean}
 * @function
 */
FlowNode.prototype.addNext = function (nextNode) {
    "use strict";
    if (FlowNode.isFlowNode(nextNode) && !this.hasNext(nextNode)) {
        internal(this)._next.push(nextNode);
    }
};

/**
* Remove a previous node from the collection of this node
* @param prevNode
* @function
*/
FlowNode.prototype.removePrev = function (prevNode) {
    "use strict";
    if (FlowNode.isFlowNode(prevNode) && this.hasPrev(prevNode)) {
        var index = -1;
        internal(this)._prev.forEach(function (node, i) {/// find the index of the prevNode
            if (node === prevNode) {
                index = i;
            }
        });
        if (index >= 0) {/// remove from the array of previous nodes
            internal(this)._prev.splice(index, 1);
        }
    }
};

/**
 * Remove a next node from the collection of this node
 * @param nextNode
 * @function
 */
FlowNode.prototype.removeNext = function (nextNode) {
    "use strict";
    if (FlowNode.isFlowNode(nextNode) && this.hasNext(nextNode)) {
        var index = -1;
        internal(this)._next.forEach(function (node, i) {/// find the index of the nextNode
            if (node === nextNode) {
                index = i;
            }
        });
        if (index >= 0) {/// remove from the array of next nodes
            internal(this)._next.splice(index, 1);
        }
    }
};
...
FlowNode.prototype.connect = function (nextNode, connectionType) {
    "use strict";
    if (FlowNode.isFlowNode(nextNode) && FlowNode.isValidNodeType(connectionType) && !this.isConnectedTo(nextNode)) {
