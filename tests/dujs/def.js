...
describe('Def', function () {
    describe('constructor', function () {
        it('should construct well', function () {
            ...
            (function () {
                new Def(-1, 'object', new Range(0, 1), new Scope('fun'));
            }).should.throw('Invalid Def value (from node or type)');
            (function () {
                new Def(0, 'invalid', new Range(0, 1), new Scope('fun'));
            }).should.throw('Invalid Def value (from node or type)');
            (function () {
                new Def(0, 'object', [1, 0], new Scope('fun'));
            }).should.throw('Invalid Def value (range)');
            (function () {
                new Def(0, 'object', new Range(0, 1), 'Program');
    ...
    describe('methods', function () {
        describe('validate', function () {
            it('should validate node and type', function () {
                ...
                (function () {
                    new Def(0, 'not-a-type', new Range(0, 1), new Scope('fun'));
                }).should.throw('Invalid Def value (from node or type)');
                (function () {
                    new Def(0, 'invalid', new Range(0, 1), new Scope('fun'));
                }).should.throw('Invalid Def value (from node or type)');
                ...
                (function () {
                    new Def(0, 'object', new Range(0, 1), new Scope('fun'));
                }).should.not.throw();
                (function () {
                    new Def(1, 'object', new Range(0, 1), new Scope('fun'));
                }).should.not.throw();
                (function () {
                    new Def(1, 'literal', new Range(0, 1), new Scope('fun'));
                }).should.not.throw();
                (function () {
                    new Def(1, 'function', new Range(0, 1), new Scope('fun'));
                }).should.not.throw();
                (function () {
                    new Def(1, 'undefined', new Range(0, 1), new Scope('fun'));
                }).should.not.throw();
            });
        });
