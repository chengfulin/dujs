        ...
        describe('Getting Intra-procedural Analysis Items', function () {
            describe('from only one scope', function () {
                ...
                it('should construct CFG correctly', function () {
                    ...
                    /// Check properties
                    should.exist(result.intraProceduralAnalysisItems[0]._testonly_._graph);
                    CFGExt.isValidCFG(result.intraProceduralAnalysisItems[0]._testonly_._graph).should.eql(true);
                    var cfg = result.intraProceduralAnalysisItems[0]._testonly_._graph;
                ...
                it('should set variables well', function () {
                    /// Global VarDefs
                    should.exist(result.intraProceduralAnalysisItems[0]._testonly_._graph[0]._testonly_._generate);
                    result.intraProceduralAnalysisItems[0]._testonly_._graph[0]._testonly_._generate.size.should.eql(4);
                    var genAtEntry = result.intraProceduralAnalysisItems[0]._testonly_._graph[0]._testonly_._generate;
                    ...
                    /// Vars
                    should.exist(result.intraProceduralAnalysisItems[0]._testonly_._relatedScopes[0]._testonly_._vars);
                    result.intraProceduralAnalysisItems[0]._testonly_._relatedScopes[0]._testonly_._vars.size.should.eql(4);
                    var variables = result.intraProceduralAnalysisItems[0]._testonly_._relatedScopes[0]._testonly_._vars;
            ...
            describe('from two scopes', function () {
                ...
                it('should construct CFG correctly', function () {
                    ...
                    /// Check properties
                    should.exist(result.intraProceduralAnalysisItems[1]._testonly_._graph);
                    CFGExt.isValidCFG(result.intraProceduralAnalysisItems[1]._testonly_._graph).should.eql(true);
                    var cfg = result.intraProceduralAnalysisItems[1]._testonly_._graph;
                ...
                it('should set variables well', function () {
                    /// Params VarDef
                    should.exist(result.intraProceduralAnalysisItems[1]._testonly_._graph[0]._testonly_._generate);
                    result.intraProceduralAnalysisItems[1]._testonly_._graph[0]._testonly_._generate.size.should.eql(2);
                    var genAtEntry = result.intraProceduralAnalysisItems[1]._testonly_._graph[0]._testonly_._generate;
                    var varNames = ['c', 'd'];
                    genAtEntry.values().every(function (vardef) {
                        return varNames.indexOf(vardef._testonly_._var._testonly_._name) !== -1;
                    }).should.eql(true);
                    ...
                    /// function VarDef
                    result.intraProceduralAnalysisItems[0]._testonly_._graph[0]._testonly_._generate.size.should.eql(5);
                    var programEntryVarDefs = result.intraProceduralAnalysisItems[0]._testonly_._graph[0]._testonly_._generate;
                    ...
                    /// Vars
                    should.exist(result.intraProceduralAnalysisItems[1]._testonly_._relatedScopes[0]._testonly_._vars);
                    result.intraProceduralAnalysisItems[1]._testonly_._relatedScopes[0]._testonly_._vars.size.should.eql(2);
                    var variables = result.intraProceduralAnalysisItems[1]._testonly_._relatedScopes[0]._testonly_._vars;
                    variables.has('c').should.eql(true);
                    variables.has('d').should.eql(true);

                    /// function variable
                    var programVars = result.intraProceduralAnalysisItems[0]._testonly_._relatedScopes[0]._testonly_._vars;
