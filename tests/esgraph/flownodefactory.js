...
describe('Factory Methods', function () {
    ...
    describe('resetCounter', function () {
        it('should reset counter of FlowNodes', function () {
            factoryFlowNode._testonly_._counter = 1;
            factoryFlowNode.resetCounter();
            factoryFlowNode._testonly_._counter.should.eql(0);
        });
    });

    describe('Factory Methods', function () {
        beforeEach(function () {
            factoryFlowNode._testonly_._counter = 0;
        });
        ...
        describe('create', function () {
            it('should support to create all kinds of nodes', function () {
                ...
                normalNode._testonly_._cfgId.should.eql(0);
                entryNode._testonly_._cfgId.should.eql(1);
                exitNode._testonly_._cfgId.should.eql(2);
                callNode._testonly_._cfgId.should.eql(3);
                callReturnNode._testonly_._cfgId.should.eql(4);
                loopNode._testonly_._cfgId.should.eql(5);
                loopRetrunNode._testonly_._cfgId.should.eql(6);
